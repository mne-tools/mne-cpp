...
#
#  Usage:
#    ./tools/build_and_test.sh                # Release build, run tests
#    ./tools/build_and_test.sh coverage       # Same but with gcov coverage
#    ./tools/build_and_test.sh Debug          # Debug build, run tests
#    ./tools/build_and_test.sh Debug coverage # Debug + coverage
#    ./tools/build_and_test.sh help           # Show help
#
#  The script:
...
#    6. Runs all tests via tools/test_all.bat
...
show_help() {
  ...
  Usage: ./tools/build_and_test.sh [options]
  ...
  Examples:
    ./tools/build_and_test.sh                  # Quick Release build + tests
    ./tools/build_and_test.sh coverage         # Release + coverage analysis
    ./tools/build_and_test.sh Debug coverage   # Debug + coverage analysis
