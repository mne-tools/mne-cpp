...
# inFile = open('c:/projects/mne-cpp/doc/gh-pages/pages/documentation/analyze_dipolefit.md','r', encoding='utf8')
# fileText = inFile.read()
# inFile.close()

# aa = mne_cpp.core.extractFilePaths(fileText, file_ext_separator = 'first')
