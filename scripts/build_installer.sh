...
#
# Usage:
#   ./scripts/build_installer.sh                      # download from GH Releases
#   ./scripts/build_installer.sh --archive <FILE>     # use a local archive
#   ./scripts/build_installer.sh --tag v0.1.0         # download a specific tag
#
# Prerequisites:
...
INSTALLER_DIR="${REPO_ROOT}/scripts/packaging/installer"
PACKAGES_DIR="${INSTALLER_DIR}/packages"
SCRIPTS_DIR="${REPO_ROOT}/scripts/packaging/scripts"
