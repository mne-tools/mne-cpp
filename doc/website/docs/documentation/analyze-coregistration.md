...
2. Load the BEM file of your choise via the [Data Loader](analyze-datamanager.md). Go to `Files` -> `Load` -> choose the Bem.

## Co-Registration Plugin

### Load and Store
<img src="/img/analyze/mne_an_coreg_load.png" width="300" height="auto" />
...
### Fit
<img src="/img/analyze/mne_an_coreg_fit.png" width="300" height="auto" />
...
<img src="/img/analyze/mne_an_coreg_adjust.png" width="300" height="auto" />
