...
* Sensor Plugins: [FiffSimulator plugin](scan-prerecordeddata.md), [FieldTripBuffer plugin](scan-ftbuffer.md)
* [HPI Fitting plugin](scan-headmonitoring.md)

## Output

The computed forward solution can be passed to the [Source Localization plugin](scan-sourceloc.md).

## Setup

1. Load the Forward Solution Plugin from the Algorithm Plugins available in MNE Scan

<img src="/img/mne_scan_fwdLoadPlugin.png" width="200" height="auto" />
...
<img src="/img/mne_scan_fwdSettings.png" width="auto" height="auto" />
...
<img src="/img/hpi/mne_scan_open_quick.png" width="200" height="auto" />

4. Navigate to the `Forward Solution` tab. 

<img src="/img/mne_scan_fwdControlWidget.png" width="300" height="auto" />
...
<img src="/img/mne_scan_fwdPipelines.png" width="400" height="auto" />
...
* [HPI Fitting plugin](scan-headmonitoring.md)
* [Source Localization plugin](scan-sourceloc.md).
