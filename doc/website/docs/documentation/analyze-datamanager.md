...
![](/img/analyze/mne_an_datamanager_1.png)
...
![](/img/analyze/mne_an_datamanager_3.png)

Items can be removed by right clicking and selecting `Remove`, and can be moved into other available sessions or subjects.

You can select between .fif files and events to pick which one to display in the [Data Viewer](analyze-rawdataviewer.md), and averages to pick which will be displayed in [Averaging](analyze-average.md).
