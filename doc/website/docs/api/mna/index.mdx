---
id: index
title: "MNA Library (Modular Architecture)"
sidebar_label: Overview
sidebar_position: 0
---

# MNA Library (Modular Architecture)

**Namespace:** `MNALIB` &nbsp;·&nbsp; **Source:** `src/libraries/mna`
The `mne_mna` library (`MNALIB` namespace) implements the MNA graph-execution engine — a framework for defining, validating, serializing, and executing MEG/EEG analysis pipelines as directed acyclic graphs (DAGs). It is the runtime behind the [MNA project format](/docs/manual/mna-format).
...
- [MNA Format](/docs/manual/mna-format) — Format specification and examples
- [Library API](/docs/api) — Overview of all MNE-CPP libraries
- [Tools Overview](/docs/manual/tools-overview) — Command-line tools including `mne_show_mna`
