...
Delegates to [`MnaIO`](/docs/api/mna/mna-io).
...
- *[MnaProject](/docs/api/mna/mna-project)* — The deserialized [`MnaProject`](/docs/api/mna/mna-project).
...
- **project** : *const [MnaProject](/docs/api/mna/mna-project) &*
