...
- **compchs** : *QList&lt; [FiffChInfo](/docs/api/fiff/fiff-ch-info) &gt;*
...
- **comp_chs** : *QList&lt; [FiffChInfo](/docs/api/fiff/fiff-ch-info) &gt;*
...
- *std::unique_ptr&lt; [MNECTFCompDataSet](/docs/api/mne/mnectf-comp-data-set) &gt;* — A new compensation data set, or nullptr on failure.
