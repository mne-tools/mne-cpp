...
**Namespace:** `MNELIB` &nbsp;·&nbsp; **Source:** `src/libraries/mne`
...
For method signatures, inheritance diagrams, and source-level documentation see the auto-generated [**MNELIB namespace**](https://mne-cpp.github.io/doxygen-api/namespaceMNELIB.html) in the Doxygen API reference.

## See Also

- [Library API Overview](/docs/api) — All MNE-CPP libraries
- [Fiff Library](/docs/api/fiff/) — FIFF file I/O that feeds into Mne data structures
- [Forward Library](/docs/api/fwd/) — Forward modelling built on Mne source spaces and BEM
- [Inverse Library](/docs/api/inv/) — Source estimation using Mne operators
