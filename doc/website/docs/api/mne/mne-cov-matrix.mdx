...
Stores a noise or source covariance matrix in dense (packed lower-triangle), diagonal, or sparse form together with its eigendecomposition and associated metadata (projection operator, [SSS](/docs/api/dsp/sss) info, channel classification, bad channels).
...
- **p_cov_sparse** : *[FiffSparseMatrix](/docs/api/fiff/fiff-sparse-matrix) **
...
Create a deep copy of this covariance matrix including data, channel classes, bad channel list, projection, and [SSS](/docs/api/dsp/sss) info.

**Returns:**

- *std::unique_ptr&lt; [MNECovMatrix](/docs/api/mne/mne-cov-matrix) &gt;* — A newly allocated copy.
...
- **chs** : *const QList&lt; [FiffChInfo](/docs/api/fiff/fiff-ch-info) &gt; &*
...
- *std::unique_ptr&lt; [MNECovMatrix](/docs/api/mne/mne-cov-matrix) &gt;* — A new covariance matrix with only the selected channels, or nullptr on error.
...
- *std::unique_ptr&lt; [MNECovMatrix](/docs/api/mne/mne-cov-matrix) &gt;* — A new covariance matrix.
...
- **cov_sparse** : *[FiffSparseMatrix](/docs/api/fiff/fiff-sparse-matrix) **
...
- *std::unique_ptr&lt; [MNECovMatrix](/docs/api/mne/mne-cov-matrix) &gt;* — The covariance matrix, or nullptr on failure.
