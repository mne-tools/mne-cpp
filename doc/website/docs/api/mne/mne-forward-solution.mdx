...
- **other** : *const [MNEForwardSolution](/docs/api/mne/mne-forward-solution) &*
  [`MNE`](/docs/api/mne/mne-class) forward solution to copy from.

**Returns:**

- *[MNEForwardSolution](/docs/api/mne/mne-forward-solution) &* — Reference to this.

---

### MNEForwardSolution(other)

Move constructs an [`MNEForwardSolution`](/docs/api/mne/mne-forward-solution).
...
Destroys the [`MNEForwardSolution`](/docs/api/mne/mne-forward-solution).

---

### clear()

Initializes the [`MNE`](/docs/api/mne/mne-class) forward solution.
...
- **p_AnnotationSet** : *const [FsAnnotationSet](/docs/api/fs/fs-annotation-set) &*
...
- *[MNEForwardSolution](/docs/api/mne/mne-forward-solution)* — clustered [`MNE`](/docs/api/mne/mne-class) forward solution.
...
- *[FiffCov](/docs/api/fiff/fiff-cov)* — Orientation priors.
...
- *[MNEForwardSolution](/docs/api/mne/mne-forward-solution)* — Forward solution restricted to selected channel types.
...
- *[MNEForwardSolution](/docs/api/mne/mne-forward-solution)* — the reduced forward solution.
...
- **p_noise_cov** : *const [FiffCov](/docs/api/fiff/fiff-cov) &*
...
- **p_outNoiseCov** : *[FiffCov](/docs/api/fiff/fiff-cov) &*
...
Formerly write_solution (SVN [`MNE`](/docs/api/mne/mne-class)).
...
- *[MNEForwardSolution](/docs/api/mne/mne-forward-solution)* — reduced [`MNE`](/docs/api/mne/mne-class) forward solution.
...
- **lPickedLabels** : *const QList&lt; [FsLabel](/docs/api/fs/fs-label) &gt; &*
  The stream to which the [`MNE`](/docs/api/mne/mne-class) forward solution should be assigned to.

- **tSurfSetInflated** : *const [FsSurfaceSet](/docs/api/fs/fs-surface-set) &*
...
ToDo move this to [FiffCov](/docs/api/fiff/fiff-cov)
...
- **gain_info** : *const [FiffInfo](/docs/api/fiff/fiff-info) &*
...
- **limit_depth_chs** : *bool*
  If True, use only grad channels in depth weighting (equivalent to [`MNE`](/docs/api/mne/mne-class) C code). If grad chanels aren't present, only mag channels will be used (if no mag, then eeg). If False, use all channels. (optional).

**Returns:**

- *[FiffCov](/docs/api/fiff/fiff-cov)* — the depth prior.
