...
The [`MNE`](/docs/api/mne/mne-class) Msh Display [FsSurface](/docs/api/fs/fs-surface) Set class holds information about a set of surfaces to be rendered.
...
Constructs the [`MNEMshDisplaySurfaceSet`](/docs/api/mne/mne-msh-display-surface-set).

---

### ~MNEMshDisplaySurfaceSet()

Destroys the [`MNEMshDisplaySurfaceSet`](/docs/api/mne/mne-msh-display-surface-set).
...
- **newSurf** : *std::unique_ptr&lt; [MNEMshDisplaySurface](/docs/api/mne/mne-msh-display-surface) &gt;*
...
- **set** : *const [MNEMshLightSet](/docs/api/mne/mne-msh-light-set) &*
...
- *std::unique_ptr&lt; [MNEMshDisplaySurfaceSet](/docs/api/mne/mne-msh-display-surface-set) &gt;* — A new display surface set, or NULL on failure. Caller takes ownership.
...
- **s** : *const [MNEMshLightSet](/docs/api/mne/mne-msh-light-set) &*
  The light set to duplicate.

**Returns:**

- *std::unique_ptr&lt; [MNEMshLightSet](/docs/api/mne/mne-msh-light-set) &gt;* — A new deep copy. Caller takes ownership.
