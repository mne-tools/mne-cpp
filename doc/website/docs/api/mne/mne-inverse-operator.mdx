...
- **label** : *const [FsLabel](/docs/api/fs/fs-label) &*
...
- **noise_norm** : *Eigen::SparseMatrix&lt; double &gt; &*
  Diagonal noise-normalisation matrix (empty for [`MNE`](/docs/api/mne/mne-class)).
...
Groups source-space points within each parcellation label using [KMeans](/docs/api/math/k-means) and returns a reduced kernel together with the cluster operator.

**Parameters:**

- **annotationSet** : *const [FsAnnotationSet](/docs/api/fs/fs-annotation-set) &*
...
- *[MNEInverseOperator](/docs/api/mne/mne-inverse-operator)* — A prepared copy of the inverse operator ready for apply_inverse.
...
- **forward** : *[MNEForwardSolution](/docs/api/mne/mne-forward-solution)*
...
- *[MNEInverseOperator](/docs/api/mne/mne-inverse-operator)* — Assembled inverse operator.
...
- **inv** : *[MNEInverseOperator](/docs/api/mne/mne-inverse-operator) &*
