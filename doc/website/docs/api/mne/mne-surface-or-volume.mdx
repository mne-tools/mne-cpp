...
classDiagram
    ...
    click MNESourceSpace "/docs/api/mne/mne-source-space"
...
Constructs the [`MNE`](/docs/api/mne/mne-class) [FsSurface](/docs/api/fs/fs-surface) or Volume.

---

### ~MNESurfaceOrVolume()

Destroys the [`MNE`](/docs/api/mne/mne-class) [FsSurface](/docs/api/fs/fs-surface) or Volume description.
...
Populate the [`MNETriangle`](/docs/api/mne/mne-triangle) structures for both the full and in-use triangulations by computing edge vectors, normals, and areas.
...
Equivalent to the old [MNEHemisphere](/docs/api/mne/mne-hemisphere)::nearest_dist (VectorXd).
...
- **tri** : *const [MNETriangle](/docs/api/mne/mne-triangle) &*
