...
Boundary element model: aggregates the inner-skull, outer-skull and scalp [`MNEBemSurface`](/docs/api/mne/mne-bem-surface) objects of a head conductor model.
...
- **p_MNEBem** : *const MNEBem &*
  [`MNE`](/docs/api/mne/mne-class) BEM.
...
Destroys the [`MNE`](/docs/api/mne/mne-class) Bem.

---

### clear()

Initializes [`MNE`](/docs/api/mne/mne-class) Bem.

---

### isEmpty()

True if [`MNE`](/docs/api/mne/mne-class) Bem is empty.

**Returns:**

- *bool* — true if [`MNE`](/docs/api/mne/mne-class) Bem is empty.
...
[`MNE`](/docs/api/mne/mne-class) Toolbox function mne_write_bem_surfaces_block.
...
- *const [MNEBemSurface](/docs/api/mne/mne-bem-surface) &* — [`MNEBemSurface`](/docs/api/mne/mne-bem-surface) related to the parameter index.
...
- *[MNEBemSurface](/docs/api/mne/mne-bem-surface) &* — [`MNEBemSurface`](/docs/api/mne/mne-bem-surface) related to the parameter index.
...
- **surf** : *const [MNEBemSurface](/docs/api/mne/mne-bem-surface) &*
  BemSurface to be added.

**Returns:**

- *[MNEBem](/docs/api/mne/mne-bem) &* — [`MNEBem`](/docs/api/mne/mne-bem).
...
[Warp](/docs/api/math/warp) the Bem.
