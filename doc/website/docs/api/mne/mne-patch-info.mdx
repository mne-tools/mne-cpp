...
Implements an [`MNE`](/docs/api/mne/mne-class) Patch Information (Replaces *mnePatchInfo,mnePatchInfoRec; struct of MNE-C `mne_types.h`).
...
Constructs the [`MNE`](/docs/api/mne/mne-class) Patch Information Refactored: mne_new_patch (mne_source_space.c).

---

### ~MNEPatchInfo()

Destroys the [`MNE`](/docs/api/mne/mne-class) Patch Information Refactored: mne_free_patch (mne_source_space.c).
...
- **s** : *[MNESourceSpace](/docs/api/mne/mne-source-space) **
