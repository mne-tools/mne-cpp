...
Implements the [`MNE`](/docs/api/mne/mne-class) [FsSurface](/docs/api/fs/fs-surface) (Replaces typedef mneSurfaceOrVolume mneSurface; struct of MNE-C `mne_types.h`).
...
```mermaid
classDiagram
    MNESurfaceOrVolume <|-- MNESurface
    click MNESurfaceOrVolume "/docs/api/mne/mne-surface-or-volume"
    MNESurface <|-- MNEBemSurface
    click MNEBemSurface "/docs/api/mne/mne-bem-surface"
    MNESurface <|-- MNEMshDisplaySurface
    click MNEMshDisplaySurface "/docs/api/mne/mne-msh-display-surface"
```
...
Constructs the [`MNE`](/docs/api/mne/mne-class) [FsSurface](/docs/api/fs/fs-surface).

---

### ~MNESurface()

Destroys the [`MNE`](/docs/api/mne/mne-class) [FsSurface](/docs/api/fs/fs-surface).
...
- **user** : *const [MNEProjData](/docs/api/mne/mne-proj-data) **
  Optional [`MNEProjData`](/docs/api/mne/mne-proj-data) restricting active triangles (may be NULL).
...
- **proj_data** : *const [MNEProjData](/docs/api/mne/mne-proj-data) **
  Optional [`MNEProjData`](/docs/api/mne/mne-proj-data) restricting active triangles (may be NULL).
...
- **p** : *[MNEProjData](/docs/api/mne/mne-proj-data) &*
...
- *std::unique_ptr&lt; [MNESurface](/docs/api/mne/mne-surface) &gt;* — The loaded surface, or nullptr on failure. Caller takes ownership.
