...
Inherits core geometry (vertices, normals, triangles, neighbors) from [MNESurface](/docs/api/mne/mne-surface)/[MNESurfaceOrVolume](/docs/api/mne/mne-surface-or-volume). Adds BEM-specific computed triangle metadata (centers, normals, areas) and I/O.
...
- **outerSkin** : *const [MNEBemSurface](/docs/api/mne/mne-bem-surface) &*
...
- *QList&lt; [MNEBemSurface](/docs/api/mne/mne-bem-surface) &gt;* — A list of decimated BEM surfaces, one per target resolution.
