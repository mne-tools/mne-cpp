...
title: "CONNLIB::DebiasedSquaredWeightedPhaseLagIndex"
...
**Namespace:** `CONNECTIVITYLIB` &nbsp;·&nbsp; **Library:** Connectivity Library &nbsp;·&nbsp; **Header:** `conn/metrics/debiasedsquaredweightedphaselagindex.h`

`#include <conn/debiasedsquaredweightedphaselagindex.h>`

```cpp
class CONNLIB::DebiasedSquaredWeightedPhaseLagIndex
```
