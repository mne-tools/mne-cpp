...
- **inverse** : *const [MNEInverseOperator](/docs/api/mne/mne-inverse-operator) &*
...
- *[InvSourceEstimate](/docs/api/inv/inv-source-estimate)* — Source estimate spanning the requested time range.
