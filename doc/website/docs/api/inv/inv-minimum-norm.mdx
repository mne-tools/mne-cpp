...
- **p_inverseOperator** : *const [MNEInverseOperator](/docs/api/mne/mne-inverse-operator) &*
...
- *[InvSourceEstimate](/docs/api/inv/inv-source-estimate)* — the calculated source estimation.
...
- *const [MNESourceSpaces](/docs/api/mne/mne-source-spaces) &* — the source space corresponding to this inverse operator.
...
- *[MNEInverseOperator](/docs/api/mne/mne-inverse-operator) &* — the prepared inverse operator.

---

### setMethod(method)

Set minimum norm algorithm method ("[MNE](/docs/api/mne/mne-class)" | "dSPM" | "sLORETA" | "eLORETA").
