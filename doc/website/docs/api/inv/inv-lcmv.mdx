...
- **dataCov** : *const [FiffCov](/docs/api/fiff/fiff-cov) &*
...
- *[InvSourceEstimate](/docs/api/inv/inv-source-estimate)* — Source estimate with time courses at each source point.
...
- *[InvSourceEstimate](/docs/api/inv/inv-source-estimate)* — Source estimate with time courses.
...
- *[InvSourceEstimate](/docs/api/inv/inv-source-estimate)* — Source estimate where data column 0 contains power at each source.
