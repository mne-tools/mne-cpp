...
Constructs a default [`FiffTag`](/docs/api/fiff/fiff-tag).
...
- **p_FiffTag** : *const FiffTag &*
  [`FiffTag`](/docs/api/fiff/fiff-tag) to copy.
...
Destroys the [`FiffTag`](/docs/api/fiff/fiff-tag).
...
- *[FiffId](/docs/api/fiff/fiff-id)* — [`Fiff`](/docs/api/fiff/fiff-class) universially unique identifier.
...
- *[FiffDigPoint](/docs/api/fiff/fiff-dig-point)* — [`Fiff`](/docs/api/fiff/fiff-class) point descriptor.
...
- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — [`Fiff`](/docs/api/fiff/fiff-class) coordinate transformation descriptor.
...
- *[FiffChInfo](/docs/api/fiff/fiff-ch-info)* — [`Fiff`](/docs/api/fiff/fiff-class) channel info descriptor.
...
- *QList&lt; QSharedPointer&lt;[FiffDirEntry](/docs/api/fiff/fiff-dir-entry)&gt; &gt;* — List of directory entry descriptors.
...
- **pos** : *[FiffChPos](/docs/api/fiff/fiff-ch-pos) **
