...
- *[FiffCov](/docs/api/fiff/fiff-cov)* — Covariance solution restricted to selected channels.
...
- *[FiffCov](/docs/api/fiff/fiff-cov)* — the prepared noise covariance matrix.
...
- *[FiffCov](/docs/api/fiff/fiff-cov)* — the regularized covariance matrix.
...
- **rhs** : *const [FiffCov](/docs/api/fiff/fiff-cov) &*
  [`FiffCov`](/docs/api/fiff/fiff-cov) which should be assigned.

**Returns:**

- *[FiffCov](/docs/api/fiff/fiff-cov) &* — the copied covariance matrix.
...
- *[FiffCov](/docs/api/fiff/fiff-cov)* — The computed noise covariance matrix, or empty [`FiffCov`](/docs/api/fiff/fiff-cov) on failure.
...
- **covs** : *const QList&lt; [FiffCov](/docs/api/fiff/fiff-cov) &gt; &*
  List of covariance matrices to combine.

**Returns:**

- *[FiffCov](/docs/api/fiff/fiff-cov)* — The grand-average covariance matrix, or empty [`FiffCov`](/docs/api/fiff/fiff-cov) if covs is empty.
