...
**Namespace:** `FIFFLIB` &nbsp;·&nbsp; **Source:** `src/libraries/fiff`
...
- [Mne Library](/docs/api/mne/) — Core MNE data structures built on Fiff
- [FIFF File Format](/docs/manual/fiff-format) — Specification of the FIFF binary format
