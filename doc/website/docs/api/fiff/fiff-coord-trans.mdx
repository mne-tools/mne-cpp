...
- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — The inverted transformation.
...
- **p_Trans** : *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans) &*
...
- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — The coordinate transform, or an empty transform if not found.
...
- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — The MRI→head transform, or an empty transform if not found.
...
- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — The device→head transform, or an empty transform if not found.
...
- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — The coordinate transform, or an empty transform on failure.
...
- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — The head→MRI transform, or an empty transform on failure.
...
- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — An identity coordinate transformation.
...
- **t1** : *const [FiffCoordTrans](/docs/api/fiff/fiff-coord-trans) &*
  First transformation.

- **t2** : *const [FiffCoordTrans](/docs/api/fiff/fiff-coord-trans) &*
  Second transformation.

**Returns:**

- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — The combined transformation, or an empty transform on failure.
...
- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — The coordinate transformation.
...
- **t** : *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans) &*
  [`Fiff`](/docs/api/fiff/fiff-class) coordinate transform to which the inverse should be added.
...
- **tag** : *const std::unique_ptr&lt; [FiffTag](/docs/api/fiff/fiff-tag) &gt; &*
  The FIFF tag to read from.

**Returns:**

- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — The coordinate transform, or an empty transform if the tag is invalid.
...
- **stream** : *[FiffStream](/docs/api/fiff/fiff-stream)::SPtr &*
  The FIFF stream.

- **node** : *const [FiffDirNode](/docs/api/fiff/fiff-dir-node)::SPtr &*
...
- *[FiffCoordTrans](/docs/api/fiff/fiff-coord-trans)* — The alignment transform, or an empty transform on failure.
