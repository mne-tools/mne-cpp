...
- *[MlTensor](/docs/api/ml/ml-tensor)* — Reshaped tensor (zero-copy).
...
- *[MlTensor](/docs/api/ml/ml-tensor)* — A non-owning [`MlTensor`](/docs/api/ml/ml-tensor).
...
- *[MlTensor](/docs/api/ml/ml-tensor)* — Newly constructed tensor with shape \{rows, cols\}.
