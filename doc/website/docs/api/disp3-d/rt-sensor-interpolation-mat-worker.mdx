...
[`RtSensorInterpolationMatWorker`](/docs/api/disp3-d/rt-sensor-interpolation-mat-worker) computes dense sensor-to-surface field-mapping matrices in a background thread.
...
```mermaid
classDiagram
    QObject <|-- RtSensorInterpolationMatWorker
```
