...
- [Connectivity Library](api-connectivity) — Connectivity metrics that produce `Network` objects for 3D visualisation
- [Inverse Library](api-inverse) — Source estimation that produces `SourceEstimate` for STC overlay
