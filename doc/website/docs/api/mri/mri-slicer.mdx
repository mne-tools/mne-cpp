...
Orthogonal-plane resampler (axial / coronal / sagittal) from [`MriVolData`](/docs/api/mri/mri-vol-data) to `MriSliceImage`.
...
Extract a 2D slice from an [`MriVolData`](/docs/api/mri/mri-vol-data) volume.

**Parameters:**

- **vol** : *const [MriVolData](/docs/api/mri/mri-vol-data) &*
  Loaded MRI volume.
