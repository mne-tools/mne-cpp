...
- **p_sFile** : *const QString &*
  [`FsSurface`](/docs/api/fs/fs-surface) file name with path.
...
Destroys the [`FsSurface`](/docs/api/fs/fs-surface) class.

---

### clear()

Initializes the [`FsSurface`](/docs/api/fs/fs-surface).
...
Returns whether [`FsSurface`](/docs/api/fs/fs-surface) is empty.
...
- **p_Surface** : *[FsSurface](/docs/api/fs/fs-surface) &*
  The read surface.
