...
**Namespace:** `STATSLIB` &nbsp;·&nbsp; **Source:** `src/libraries/sts`
...
Dependencies: `mne_utils`, `mne_fiff`, Qt6::Core, Eigen3, Skigen.
...
- [DSP Library API](/docs/api/dsp/) — Filtering, spectral analysis, and preprocessing
- [Inverse Library API](/docs/api/inv/) — Source estimation methods
- [Library API](/docs/api) — Overview of all MNE-CPP libraries
- [Glossary](/docs/manual/glossary) — Statistical terms and definitions
