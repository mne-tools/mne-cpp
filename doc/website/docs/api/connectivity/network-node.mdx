---
id: network-node
title: "CONNECTIVITYLIB::NetworkNode"
...
Node of a [`Network`](/docs/api/connectivity/network).
...
[Graph](/docs/api/disp/graph) node carrying a 3D position and its incident in/out, full/thresholded edge lists.
...
Constructs a [`NetworkNode`](/docs/api/connectivity/network-node) object.
...
- *const QList&lt; QSharedPointer&lt;[NetworkEdge](/docs/api/connectivity/network-edge)&gt; &gt; &* — Returns the list with all ingoing edges.
...
- *QList&lt; QSharedPointer&lt;[NetworkEdge](/docs/api/connectivity/network-edge)&gt; &gt;* — Returns the list with all ingoing edges.
...
- *QList&lt; QSharedPointer&lt;[NetworkEdge](/docs/api/connectivity/network-edge)&gt; &gt;* — Returns the list with all outgoing edges.
