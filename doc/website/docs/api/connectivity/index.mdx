...
**Namespace:** `CONNECTIVITYLIB` &nbsp;·&nbsp; **Source:** `src/libraries/connectivity`
...
For method signatures, inheritance diagrams, and source-level documentation see the auto-generated [**CONNECTIVITYLIB namespace**](https://mne-cpp.github.io/doxygen-api/namespaceCONNECTIVITYLIB.html) in the Doxygen API reference.

## See Also

- [Library API Overview](/docs/api) — All MNE-CPP libraries
- [DSP Library](/docs/api/dsp/) — Signal processing (filtering, spectral analysis) used as input to connectivity
- [Inverse Library](/docs/api/inv/) — Source estimation for source-level connectivity
- [Disp3D Library](/docs/api/disp3-d/) — 3D network visualisation
