...
- *[FiffAnnotations](/docs/api/fiff/fiff-annotations)* — FiffAnnotations with "BAD_muscle" entries.
...
- *[FiffAnnotations](/docs/api/fiff/fiff-annotations)* — FiffAnnotations with bad entries.
