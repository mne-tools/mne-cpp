...
The detector follows MNE-Python's `mne.preprocessing.find_bad_channels_lof` so MEG / EEG pipelines can switch between the two without changing the downstream interpolation / [SSS](/docs/api/dsp/sss) step.
