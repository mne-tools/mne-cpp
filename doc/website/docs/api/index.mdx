...
| [**Connectivity**](/docs/api/connectivity/) | `CONNECTIVITYLIB` | Functional connectivity metrics: Coherence, Cross-Correlation, PLV, PLI, WPLI, and variants |
...
| Section | Description |
|---|---|
| [Namespace List](/docs/api/namespaces) | All namespaces with class inventories — one per library |
| [Class List](/docs/api/classes) | Annotated list of all classes, structs, and unions |
| [File List](/docs/api/files) | Source and header files grouped by library directory |
| [Class Hierarchy](/docs/api/hierarchy) | Inheritance tree showing parent–child relationships |
| [Class Members](/docs/api/class-members) | Index of all public class members (functions, variables, typedefs, enums) |
| [Namespace Members](/docs/api/namespace-members) | Index of all namespace-level symbols |

## External reference

The legacy auto-generated Doxygen HTML reference is still available for
cross-checking until this site is fully verified:

| Section | Description |
|---|---|
| [Doxygen API Reference](https://mne-cpp.github.io/doxygen-api/) | Full auto-generated Doxygen HTML site |
| [Namespace List](https://mne-cpp.github.io/doxygen-api/namespaces.html) | All namespaces with brief descriptions |
| [Class List](https://mne-cpp.github.io/doxygen-api/annotated.html) | Annotated list of all classes, structs, and unions |
| [Class Index](https://mne-cpp.github.io/doxygen-api/classes.html) | Alphabetical class index |
| [Class Hierarchy](https://mne-cpp.github.io/doxygen-api/hierarchy.html) | Inheritance hierarchy |
| [Class Members](https://mne-cpp.github.io/doxygen-api/functions.html) | Index of all class members (functions, variables, typedefs, enums) |
| [Namespace Members](https://mne-cpp.github.io/doxygen-api/namespacemembers.html) | Index of all namespace members |
| [File List](https://mne-cpp.github.io/doxygen-api/files.html) | List of all documented source files |
