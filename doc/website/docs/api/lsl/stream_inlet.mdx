...
Construct a new [`stream_inlet`](/docs/api/lsl/stream_inlet) from a resolved [`stream_info`](/docs/api/lsl/stream_info).

**Parameters:**

- **info** : *const [stream_info](/docs/api/lsl/stream_info) &*
  A [`stream_info`](/docs/api/lsl/stream_info) object (typically obtained from resolve_streams).
