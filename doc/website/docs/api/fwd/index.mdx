...
**Namespace:** `FWDLIB` &nbsp;·&nbsp; **Source:** `src/libraries/fwd`
...
For method signatures, inheritance diagrams, and source-level documentation see the auto-generated [**FWDLIB namespace**](https://mne-cpp.github.io/doxygen-api/namespaceFWDLIB.html) in the Doxygen API reference.

## See Also

- [Library API Overview](/docs/api) — All MNE-CPP libraries
- [Mne Library](/docs/api/mne/) — Source spaces and BEM surfaces used by the Forward library
- [Inverse Library](/docs/api/inv/) — Source estimation using the forward solution
- [Forward Modelling Background](/docs/manual/forward) — Theory and equations behind forward computation
- [Forward Solution Tool](/docs/manual/tools-forward-solution) — CLI tool `mne_forward_solution`
