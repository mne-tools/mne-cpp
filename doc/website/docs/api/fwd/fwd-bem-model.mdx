...
[FsSurface](/docs/api/fs/fs-surface) ownership is released automatically via std::unique_ptr. The solution matrix is freed by `fwd_bem_free_solution()`.
...
- *[MNESurface](/docs/api/mne/mne-surface) ** — Non-owning pointer to the surface, or nullptr if not found.
...
- **els** : *[FwdCoilSet](/docs/api/fwd/fwd-coil-set) **
...
- **coils** : *[FwdCoilSet](/docs/api/fwd/fwd-coil-set) **
  MEG coil set.
...
- **spaces** : *std::vector&lt; std::unique_ptr&lt; [MNESourceSpace](/docs/api/mne/mne-source-space) &gt; &gt; &*
  Source spaces.

- **coils** : *[FwdCoilSet](/docs/api/fwd/fwd-coil-set) **
  MEG coil set.

- **comp_coils** : *[FwdCoilSet](/docs/api/fwd/fwd-coil-set) **
  Compensator coil set (may be nullptr).

- **comp_data** : *[MNECTFCompDataSet](/docs/api/mne/mnectf-comp-data-set) **
...
- **resp** : *[FiffNamedMatrix](/docs/api/fiff/fiff-named-matrix) &*
  Forward solution matrix.

- **resp_grad** : *[FiffNamedMatrix](/docs/api/fiff/fiff-named-matrix) &*
...
- **eeg_model** : *[FwdEegSphereModel](/docs/api/fwd/fwd-eeg-sphere-model) **
...
- **guess_surf** : *[MNESurface](/docs/api/mne/mne-surface) **
...
- *std::unique_ptr&lt; [MNESurface](/docs/api/mne/mne-surface) &gt;* — FsSurface containing the guess locations, or nullptr on failure.
...
- **to** : *[MNETriangle](/docs/api/mne/mne-triangle) &*
...
- **surf** : *[MNESurface](/docs/api/mne/mne-surface) &*
  The BEM surface.
...
- **surfs** : *const std::vector&lt; [MNESurface](/docs/api/mne/mne-surface) * &gt; &*
...
- **client** : *void **
  Opaque pointer to the [`FwdBemModel`](/docs/api/fwd/fwd-bem-model) instance.
...
- **tri** : *[MNETriangle](/docs/api/mne/mne-triangle) &*
  Source triangle.
...
- **source** : *[MNETriangle](/docs/api/mne/mne-triangle) &*
  Source triangle.
...
- **arg** : *[FwdThreadArg](/docs/api/fwd/fwd-thread-arg) **
