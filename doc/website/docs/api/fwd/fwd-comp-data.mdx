...
- **client** : *void **
  Pointer to [`FwdCompData`](/docs/api/fwd/fwd-comp-data).
...
- **set** : *[MNECTFCompDataSet](/docs/api/mne/mnectf-comp-data-set) **
...
- *[FwdCompData](/docs/api/fwd/fwd-comp-data) ** — Pointer to the created [`FwdCompData`](/docs/api/fwd/fwd-comp-data), or nullptr on error. Caller owns the pointer.
