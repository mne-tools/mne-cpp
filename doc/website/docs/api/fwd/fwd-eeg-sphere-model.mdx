...
Implements [`FwdEegSphereModel`](/docs/api/fwd/fwd-eeg-sphere-model) (replaces `fwdEegSphereModel` / `fwdEegSphereModelRec` from MNE-C ``fwd_types.h``).
...
Constructs the Forward EEG [Sphere](/docs/api/math/sphere) Model.
...
- **client** : *void **
  Pointer to the [`FwdEegSphereModel`](/docs/api/fwd/fwd-eeg-sphere-model).
...
J.C. Moscher, R.M. Leahy, and P.S. Lewis, Matrix Kernels for Modeling of EEG and MEG Data, Los Alamos Technical [Report](/docs/api/utils/report), LA-UR-96-1993, 1996.
