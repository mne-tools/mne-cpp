...
Constructs a [`AverageSelectionView`](/docs/api/disp/average-selection-view) which is a child of parent.
...
Destroys the [`AverageSelectionView`](/docs/api/disp/average-selection-view).
