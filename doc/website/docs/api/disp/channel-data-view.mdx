...
Acts as the user-facing host of the [`ChannelDataModel`](/docs/api/disp/channel-data-model) and [`RtFiffRawViewDelegate`](/docs/api/disp/rt-fiff-raw-view-delegate) pair, exposing playback / zoom / channel-selection signals consumed by the surrounding plugin GUI.
...
Constructs a [`ChannelDataView`](/docs/api/disp/channel-data-view).
...
Initialise the view from a [FiffInfo](/docs/api/fiff/fiff-info) (channel names, types, sampling rate).

**Parameters:**

- **pInfo** : *QSharedPointer&lt;[FiffInfo](/docs/api/fiff/fiff-info)&gt;*
...
- **events** : *const QVector&lt; [ChannelRhiView](/docs/api/disp/channel-rhi-view)::EventMarker &gt; &*
...
- **annotations** : *const QVector&lt; [ChannelRhiView](/docs/api/disp/channel-rhi-view)::AnnotationSpan &gt; &*
