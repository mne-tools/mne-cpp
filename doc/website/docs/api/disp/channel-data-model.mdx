...
Initialise with channel metadata from a [FiffInfo](/docs/api/fiff/fiff-info).

**Parameters:**

- **pFiffInfo** : *QSharedPointer&lt;[FiffInfo](/docs/api/fiff/fiff-info)&gt;*
...
Sampling frequency in Hz; 0 if no [FiffInfo](/docs/api/fiff/fiff-info) attached.
