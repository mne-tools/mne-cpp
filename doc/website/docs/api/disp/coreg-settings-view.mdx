...
Constructs a [`CoregSettingsView`](/docs/api/disp/coreg-settings-view) object.
...
Set the the Root-Mean-Square-Error (Digitizer-[FsSurface](/docs/api/fs/fs-surface)) after icp.
