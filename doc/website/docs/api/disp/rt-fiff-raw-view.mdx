...
Owns the scrollbars, the marker / annotation machinery and the trigger-channel overlay; delegates per-row painting to [`RtFiffRawViewDelegate`](/docs/api/disp/rt-fiff-raw-view-delegate) and data access to [`RtFiffRawViewModel`](/docs/api/disp/rt-fiff-raw-view-model).
...
Constructs a [`RtFiffRawView`](/docs/api/disp/rt-fiff-raw-view) which is a child of parent.
...
Destroys the [`RtFiffRawView`](/docs/api/disp/rt-fiff-raw-view).
...
Initilaizes the [`RtFiffRawView`](/docs/api/disp/rt-fiff-raw-view) based on a [FiffInfo](/docs/api/fiff/fiff-info).
...
- **filterData** : *const [FilterKernel](/docs/api/dsp/filter-kernel) &*
