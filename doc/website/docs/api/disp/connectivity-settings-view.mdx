...
Constructs a [`ConnectivitySettingsView`](/docs/api/disp/connectivity-settings-view) which is a child of parent.
...
Destroys the [`ConnectivitySettingsView`](/docs/api/disp/connectivity-settings-view).
