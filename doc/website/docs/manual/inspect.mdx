...
An experimental [WebAssembly](online) build of MNE Inspect is available. It runs entirely **locally** inside the browser — no installation needed, no data uploaded. [Learn more about data privacy](online#data-privacy).

- **[Launch stable MNE Inspect in your browser](https://mne-cpp.github.io/wasm/mne_inspect.html)**
- **[Launch nightly MNE Inspect in your browser](https://mne-cpp.github.io/wasm/dev/mne_inspect.html)**

## Dependencies

MNE Inspect depends on the `mne_disp3D` library and is only built when this library is available. It also links against `mne_fs`, `mne_fiff`, `mne_fwd`, `mne_mne`, `mne_disp`, `mne_inv`, `mne_utils`, and `mne_connectivity`.

## See Also

- [Online Applications (WebAssembly)](online) — Browser-based MNE-CPP applications, data privacy details, and technical background
