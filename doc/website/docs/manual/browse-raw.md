...
The basic browsing functionality is available through the `mne_browse` application. For more comprehensive raw data browsing and analysis capabilities, consider using the **[MNE Analyze](analyze-manual)** application or **[MNE Scan](../documentation/scan)** for real-time data viewing.

## See Also

- [MNE Analyze](analyze-manual) — For offline analysis including raw data viewing
- [MNE Scan](../documentation/scan) — For real-time data acquisition and browsing
