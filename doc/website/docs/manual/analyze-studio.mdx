...
- [Library API](/docs/api) — Detailed documentation of the underlying C++ libraries
- [DSP Library](/docs/api/dsp/) — Signal processing algorithms available to extensions
