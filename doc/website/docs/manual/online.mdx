...
Stable WebAssembly builds are published at `https://mne-cpp.github.io/wasm/`. Nightly development builds from the `staging` branch are published alongside them at `https://mne-cpp.github.io/wasm/dev/`.
...
<div style={{display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem'}}>
  ...
  <span>[Full documentation](analyze) &nbsp;·&nbsp; **[Stable](https://mne-cpp.github.io/wasm/mne_analyze.html)** &nbsp;·&nbsp; **[Nightly](https://mne-cpp.github.io/wasm/dev/mne_analyze.html)**</span>
</div>
...
<div style={{display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem'}}>
  ...
  <span>[Full documentation](browse-raw) &nbsp;·&nbsp; **[Stable](https://mne-cpp.github.io/wasm/mne_browse.html)** &nbsp;·&nbsp; **[Nightly](https://mne-cpp.github.io/wasm/dev/mne_browse.html)**</span>
</div>
...
<div style={{display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem'}}>
  ...
  <span>[Full documentation](inspect) &nbsp;·&nbsp; **[Stable](https://mne-cpp.github.io/wasm/mne_inspect.html)** &nbsp;·&nbsp; **[Nightly](https://mne-cpp.github.io/wasm/dev/mne_inspect.html)**</span>
</div>
...
<div style={{display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem'}}>
  <span>[Full documentation](tools-anonymize) &nbsp;·&nbsp; **[Stable](https://mne-cpp.github.io/wasm/mne_anonymize.html)** &nbsp;·&nbsp; **[Nightly](https://mne-cpp.github.io/wasm/dev/mne_anonymize.html)**</span>
</div>
...
- **3D visualization.** The RHI-based `disp3D` library provides 3D rendering in the browser via WebGL. Some advanced 3D features may behave differently across browsers.
