...
<!-- screenshot: doc/website/static/img/mne-scan-main-window.png — empty main window after first launch -->
...
<!-- screenshot: doc/website/static/img/mne-scan-pipeline-fiffsim-writetofile.png — wired pipeline: FiffSimulator → writetofile -->
