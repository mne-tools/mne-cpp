...
The MNE-CPP FIFF library (`FIFFLIB`) provides complete read/write support for FIFF files. See the [Library API](/docs/api) for programmatic access.
...
- [Library API](/docs/api) — Programmatic access to FIFF files via `FIFFLIB`
