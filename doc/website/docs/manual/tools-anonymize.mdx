...
An experimental [WebAssembly](online) build of MNE Anonymize is available. It runs entirely **locally** inside the browser — no installation needed, no data uploaded. Load a FIFF file, anonymize it, and download the result — all without any data leaving your machine. [Learn more about data privacy](online#data-privacy).

- **[Launch stable MNE Anonymize in your browser](https://mne-cpp.github.io/wasm/mne_anonymize.html)**
- **[Launch nightly MNE Anonymize in your browser](https://mne-cpp.github.io/wasm/dev/mne_anonymize.html)**
