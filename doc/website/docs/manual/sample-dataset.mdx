...
This chapter gives a detailed description of the processing of the MNE sample dataset, which can be employed to familiarize with the [Cookbook](cookbook) workflow.
...
- [Cookbook](cookbook) — The general processing workflow
