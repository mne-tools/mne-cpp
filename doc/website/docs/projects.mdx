...
sidebar_label: "Projects and Funding"
sidebar_position: 2
---

# Projects and Funding

At present, there are several projects funded by NIH and European funding agencies, which capitalize on MNE-CPP. While these projects benefit from the existing resources in MNE-CPP, they all also contribute to MNE-CPP, making the framework more comprehensive.
...
[![National Institutes of Health (NIH)](/img/funding_logos/nih.svg)](https://www.nih.gov/)
[![National Institute of Biomedical Imaging and Bioengineering (NIBIB)](/img/funding_logos/nibib.svg)](https://www.nibib.nih.gov/)
[![Deutsche Forschungsgesellschaft](/img/funding_logos/dfg.svg)](https://www.dfg.de/)
[![FWF Der Wissenschaftsfonds](/img/funding_logos/fwf.svg)](https://m.fwf.ac.at/)
[![Amazon Web Service (AWS)](/img/funding_logos/aws.svg)](https://aws.amazon.com/)
[![Microsoft Azure](/img/funding_logos/azure.svg)](https://azure.microsoft.com/)
