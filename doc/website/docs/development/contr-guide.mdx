...
1. Setup MNE-CPP to [build from source](buildguide-cmake.mdx).
2. Familiarize yourself with our [coding conventions](contr-style.mdx).
...
8. After you created the pull request, wait for the [Continuous Integration](ci.mdx) checks and subsequent review process to finish:
