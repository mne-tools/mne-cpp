...
:::tip Live Demo
Try MNE Analyze in your browser right now:

- Stable: [mne-cpp.github.io/wasm/mne_analyze.html](https://mne-cpp.github.io/wasm/mne_analyze.html)
- Nightly: [mne-cpp.github.io/wasm/dev/mne_analyze.html](https://mne-cpp.github.io/wasm/dev/mne_analyze.html)
:::
...
- 3D visualization via `disp3D` is supported in WebAssembly builds when `Qt6::GuiPrivate` is available. The RHI backend uses OpenGL (WebGL) in the browser.
