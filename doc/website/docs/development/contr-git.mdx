...
```
  ...
  If GitHub later shows **"This branch cannot be rebased due to conflicts"**, resolve the conflicts locally during this rebase and then push with `--force-with-lease`.
