...
The first steps to get started, as described in the [build guide](buildguide-cmake.mdx), are:
```
...
- Commit the added files (colored in green in status report) and add a meaningful message about what changed and why (have a look at our [commit policy](contr-style.mdx)):
