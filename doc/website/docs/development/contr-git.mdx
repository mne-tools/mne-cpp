...
See the [Release Guide](ci-releasecycle.mdx) for a detailed description of the branch model and release process.
...
- Open a pull request targeting the **`staging`** branch on the upstream repository.
