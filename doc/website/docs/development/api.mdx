...
The full auto-generated API documentation is available at the [API Reference](https://mne-cpp.github.io/doxygen-api/). Use these entry points to navigate the reference:

| Section | Description |
|---|---|
| [Namespace List](https://mne-cpp.github.io/doxygen-api/namespaces.html) | All namespaces with brief descriptions — one per library (e.g. `UTILSLIB`, `FIFFLIB`, `MNELIB`, `INVERSELIB`) |
| [Class List](https://mne-cpp.github.io/doxygen-api/annotated.html) | Alphabetical list of all classes, structs, and unions with brief descriptions |
| [Class Index](https://mne-cpp.github.io/doxygen-api/classes.html) | Compact alphabetical class index for quick lookup |
| [Class Hierarchy](https://mne-cpp.github.io/doxygen-api/hierarchy.html) | Inheritance tree showing parent-child relationships between classes |
| [Class Members](https://mne-cpp.github.io/doxygen-api/functions.html) | Index of all documented class members (functions, variables, enums, typedefs) |
| [Namespace Members](https://mne-cpp.github.io/doxygen-api/namespacemembers.html) | Index of all symbols declared at namespace scope |
| [File List](https://mne-cpp.github.io/doxygen-api/files.html) | All source and header files with directory structure |
