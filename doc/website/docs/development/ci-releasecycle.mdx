...
- [MNE Scan info.h](https://github.com/mne-tools/mne-cpp/blob/staging/src/applications/mne_scan/mne_scan/info.h)
- [MNE Analyze info.h](https://github.com/mne-tools/mne-cpp/blob/staging/src/applications/mne_analyze/mne_analyze/info.h)
...
- Runs the deployment scripts (`scripts/deploy/deploy.bat`) to bundle Qt dependencies
