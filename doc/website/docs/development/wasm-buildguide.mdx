...
```bash
./scripts/wasm/wasm.sh --emsdk 4.0.7 --qt $HOME/Qt/6.10.2 --qt-host $HOME/Qt/6.10.2/gcc_64
```
...
**Automatic fix (recommended):** Run the post-build script to inject a [COI service worker](https://github.com/nickvdp/coi-serviceworker) that adds these headers client-side — this works on any static host including GitHub Pages:

```bash
./scripts/wasm/wasm_postbuild.sh out/wasm/apps
```
...
See the [Qt for WebAssembly documentation](https://doc.qt.io/qt-6/wasm.html) for details.
:::
...
- Stable: [https://mne-cpp.github.io/wasm/mne_analyze.html](https://mne-cpp.github.io/wasm/mne_analyze.html)
- Nightly: [https://mne-cpp.github.io/wasm/dev/mne_analyze.html](https://mne-cpp.github.io/wasm/dev/mne_analyze.html)
