...
The [CMake Build Guide](buildguide-cmake.md) goes through the process of building the current version of the project. The [qmake Build Guide](buildguide-qmake.md) is for older versions of the project. If you are building the project from the main repository's main branch, you'll want to follow the [CMake guide](buildguide-cmake.md)
