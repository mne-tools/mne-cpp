...
4. Push your changes to your remote (forked GitHub) repository.
5. Check if your changes pass the CI tests by running `git push origin <yourBranchName>:testci -f`. Check the Actions tab on your forked MNE-CPP repository's Github page and fix possible problems.
6. Once all CI tests pass, go to your remote (forked GitHub) repository via the GitHub website and create a pull request:
...
7. After you created the pull request, wait for the [Continuous Integration](ci.md) checks and subsequent review process to finish:
...
8. Congratulations! You are now an official contributor to the MNE-CPP project.
