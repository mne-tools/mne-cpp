...
6. After the build process is finished, go to the `mne-cppout/Release` folder. All applications and libraries should have been created throughout the build process.
