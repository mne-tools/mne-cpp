...
* \textbf{utils} - Design patterns, generlaized classes, mathematical routines, I/O helpers
* \textbf{fs} - FreeSurfer I/O routines
* \textbf{fiff} - Fiff I/O routines
* \textbf{mne} - I/O routines for MNE objects
* \textbf{fwd} - Forward modeling
* \textbf{inverse} - Inverse modeling
* \textbf{communication} - Tools for real-time communication
* \textbf{rtprocessing} - Tools for real-time data processing
* \textbf{connectivity} - Functional connectivity metrics
* \textbf{disp} - 2D visualization routines
* \textbf{disp3D} - 3D visualization routines
