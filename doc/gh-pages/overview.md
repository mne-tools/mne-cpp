...
MNE-CPP is both an open source collection of cross-platform software tools and a framework for development. We provide two main GUI applications, MNE Scan and MNE Analyze, as well as a command line application, MNE Anonymize. MNE Scan is used for acquisition and real-time processing, while MNE Analyze is used for visualization and analysis of pre-recorded data. MNE Anonymize is used for anonymizing data files by removing identifiable subject/patient data from collected data files.
