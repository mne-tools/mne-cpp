 ...
 * ...).
 *
 * Both structs are POD-like and round-trip through @c QSettings so
 * the user's last camera and per-pane filter are restored when the
 * host application is relaunched.
 */
