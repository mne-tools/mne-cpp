...
//    MNELIB::MnePatchInfo* patch;    /* The patch information record for the patch this vertex belongs to */
...
/*
 * The class field in MNELIB::MneCovMatrix* can have these values
 */
...
//} *MNELIB::MneCovMatrix*,MNELIB::MneCovMatrix*Rec;
...
//  MNELIB::MneCovMatrix*   noise_cov;	/* The noise covariance matrix employed in whitening */
...
//  MNELIB::MneSurfaceOrVolume::MneCSourceSpace* *spaces;               /* The source spaces */
//  int            nspace;	          /* Number of source spaces */
...
//  MNELIB::MneDeriv*     deriv_matched;	/* Derivation data matched to this raw data and
...
//  MNELIB::MneMeasDataSet*     *sets;	 /* All loaded data sets */
//  int                nset;	 /* How many */
