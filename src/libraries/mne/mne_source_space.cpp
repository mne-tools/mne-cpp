 ...
 * @c _SELECTION and the neighbour tables), plus decimation, patch-info
 * loading and basic geometric utilities (vertex area, nearest neighbour).
 * All routines are designed to behave identically to the @c read_source_spaces
 * function in the MNE-Python source.
 */
