 ...
 * applies the corresponding rank-one removal to sensor data, leadfields
 * or noise covariances. Used by the raw, evoked and forward paths to
 * keep all data products in the same projected subspace.
 */
