 ...
 * @since 2026
 * @date  April 2026
 * @brief Implementation of @ref MNELIB::MNEMeasData.
 *
 * Implements construction, ownership of the contained measurement data
 * sets and the projection bookkeeping that the MNE C tools expected.
 */
