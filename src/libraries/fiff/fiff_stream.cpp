 ...
 * on open; trades tag streams for typed FIFFLIB objects on read; emits
 * spec-compliant FIFF on write. Files emitted here round-trip through
 * @c mne.io.fiff unchanged.
 */
