 ...
 * directory tag is parsed; @ref dir_tree_find drives every higher-level
 * reader (@ref FiffInfo, @ref FiffRawData, @ref FiffEvoked,
 * @ref FiffCov, ...) to its block of interest.
 */
