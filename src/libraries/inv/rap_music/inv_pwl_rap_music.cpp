 ...
 * the @c PowellOffset / @c PowellIdxVec helpers that linearise pair
 * indices into a 1-D parameter and the three @c calculateInverse
 * overrides that dispatch evoked / raw / paired-output calls back into
 * the base @ref InvRapMusic pipeline with the Powell scanner installed.
 */
