 ...
 * orientation), the parallelised over-pair scan loop, the recursive
 * sub-space projection that removes already-found dipole pairs from
 * the search, and the final assembly of the per-iteration dipole-pair
 * list into the dense @ref InvSourceEstimate output.
 */
