 ...
 * that enforces mandatory combinations (e.g. noise covariance vs.
 * ad-hoc per-channel-type standard deviations) and the human-readable
 * usage banner used by the @c mne_dipole_fit driver binary.
 */
