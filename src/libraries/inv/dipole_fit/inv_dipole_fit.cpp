 ...
 * and assembles the per-time-point @ref InvEcd records into the output
 * @ref InvEcdSet. Refactored from @c fit_dipoles.c / @c fit_dipoles_raw
 * in the MNE-C reference implementation.
 */
