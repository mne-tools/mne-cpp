 ...
 * function needs to evaluate a candidate dipole: coordinate transforms,
 * channel selection, MEG coil and EEG electrode definitions, the
 * forward-model function pointers (sphere model and/or BEM), the
