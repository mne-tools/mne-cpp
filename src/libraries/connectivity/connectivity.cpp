 ...
 * @since    0.1.0
 * @date     March 2017
 * @brief    Implementation of @ref CONNECTIVITYLIB::Connectivity - the dispatcher that runs the requested functional-connectivity metrics over a @ref CONNECTIVITYLIB::ConnectivitySettings batch.
 *
 * The single entry point @ref CONNECTIVITYLIB::Connectivity::calculate inspects the
 * list of method names on @ref CONNECTIVITYLIB::ConnectivitySettings and routes
