 ...
 * @since    0.1.0
 * @date     April 2018
 * @brief    Implementation of @ref CONNECTIVITYLIB::Coherence - magnitude-squared coherence between every channel pair, computed from the shared DPSS-tapered cross-spectral cache.
 */
