 ...
 * @since    2.2.0
 * @date     April 2026
 * @brief    Implementation of @ref CONNECTIVITYLIB::PartialDirectedCoherence - column-normalised |A(f)| directional connectivity (Baccala & Sameshima 2001), direct paths only.
 */
