 ...
 * @since    0.1.0
 * @date     April 2018
 * @brief    Implementation of @ref CONNECTIVITYLIB::ImagCoherence - the volume-conduction-robust imaginary part of complex coherency of Nolte et al. (NeuroImage 2004).
 */
