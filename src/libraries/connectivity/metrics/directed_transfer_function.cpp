 ...
 * @since    2.2.0
 * @date     April 2026
 * @brief    Implementation of @ref CONNECTIVITYLIB::DirectedTransferFunction - row-normalised |H(f)|^2 directional connectivity (Kaminski & Blinowska 1991), driven by the shared @ref CONNECTIVITYLIB::MvarModel fit.
 */
