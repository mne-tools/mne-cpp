 ...
 * @since    0.1.0
 * @date     January 2018
 * @brief    Implementation of @ref CONNECTIVITYLIB::AbstractMetric - holds the static control knobs (storage-mode flag and band-averaging window) shared by every CONNECTIVITYLIB estimator.
 */
