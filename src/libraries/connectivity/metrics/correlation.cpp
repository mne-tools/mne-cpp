 ...
 * @since    0.1.0
 * @date     January 2018
 * @brief    Implementation of @ref CONNECTIVITYLIB::Correlation - trial-averaged zero-lag Pearson correlation between every channel pair, run in parallel via @c QtConcurrent::mappedReduced.
 */
