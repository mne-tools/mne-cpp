 ...
 * @since    0.1.0
 * @date     January 2018
 * @brief    Implementation of @ref CONNECTIVITYLIB::CrossCorrelation - lag-resolved cross-correlation between every channel pair, computed via the inverse FFT of the DPSS-tapered cross-spectrum.
 */
