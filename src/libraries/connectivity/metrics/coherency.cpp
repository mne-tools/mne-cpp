 ...
 * @since    0.1.0
 * @date     April 2018
 * @brief    Implementation of @ref CONNECTIVITYLIB::Coherency - shared cross/auto-spectral core for magnitude-squared coherence and the volume-conduction-robust imaginary coherence of Nolte et al. (2004).
 */
