 ...
 * @since    0.1.0
 * @date     April 2018
 * @brief    Implementation of @ref CONNECTIVITYLIB::DebiasedSquaredWeightedPhaseLagIndex - the small-sample-bias-corrected squared wPLI estimator of Vinck et al. (NeuroImage 2011).
 */
