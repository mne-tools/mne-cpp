 ...
 * @since    2.2.0
 * @date     April 2026
 * @brief    Implementation of @ref CONNECTIVITYLIB::MvarModel - Yule-Walker / Levinson-Durbin MVAR fit and frequency-domain decomposition into H(f) and S(f); backbone of the directed-connectivity metrics.
 */
