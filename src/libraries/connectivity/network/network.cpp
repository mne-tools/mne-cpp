 ...
 * @since    0.1.0
 * @date     August 2016
 * @brief    Implementation of @ref CONNECTIVITYLIB::Network - graph container for one connectivity result, including thresholding, distance-table computation and full / thresholded adjacency-matrix extraction.
 */
