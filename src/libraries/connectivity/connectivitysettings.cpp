 ...
 * @since    0.1.0
 * @date     March 2017
 * @brief    Implementation of @ref CONNECTIVITYLIB::ConnectivitySettings - the input/parameter container shared by every functional-connectivity metric in @c CONNECTIVITYLIB.
 *
