...
void AnnotationWindow::setupUi()
{
    ...
    m_pHintLabel = new QLabel(QStringLiteral("Enable annotation mode and right-drag in the raw view to create time spans. The manager can edit MNE-style descriptions, channels, comments, and import/export JSON, CSV, TXT, or FIF annotation files."), m_pContents);
