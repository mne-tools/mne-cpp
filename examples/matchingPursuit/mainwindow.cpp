...
void MainWindow::iteration_counter(qint32 current_iteration, qint32 max_iterations, qreal current_energy, qreal max_energy, QList<GaborAtom> atom_res_list)
{
    ...
    /*
    GaborAtom a = atom_res_list.last();
    qint32 index = atom_res_list.count() - 1;
    qreal percent_atom_energy = 100 * a.energy / max_energy;

    QTableWidgetItem* atomEnergieItem = new QTableWidgetItem(QString::number(percent_atom_energy, 'f', 2));
    QTableWidgetItem* atomScaleItem = new QTableWidgetItem(QString::number(a.scale, 'g', 3));
    QTableWidgetItem* atomTranslationItem = new QTableWidgetItem(QString::number(a.translation, 'g', 3));
    QTableWidgetItem* atomModulationItem = new QTableWidgetItem(QString::number(a.modulation, 'g', 3));
    QTableWidgetItem* atomPhaseItem = new QTableWidgetItem(QString::number(a.phase, 'g', 3));
    ...
    ui->tbv_Results->setItem(index, 4, atomPhaseItem);atom_res_list.last();
    */
