...
class RTDevice{
    ...
    public:
        ...
        PSP_DEVICE_PATH GetInstanceId( LONG DeviceIndex , BOOLEAN Present, ULONG  *MaxDevices = NULL )
        {   ULONG lMaxDevices = 0;
        ...
        BOOLEAN SetSignalBuffer(PULONG SampleRate,PULONG BufferSize);
        //Get info about the status of the signal buffer
        BOOLEAN GetBufferInfo(PULONG OverflowCounter,PULONG PercentFull);
